 ...
 * [nutrikit.yml](nutrikit.yml)
     * Determines how your purl.obolibrary.org/obo/nutrikit/ redirects will be handled
     ...
     * Paste in the contents of [nutrikit.yml](nutrikit.yml)
 ...
 * [nutrikit.md](nutrikit.md)
     ...
     * Paste in the contents of [nutrikit.md](nutrikit.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
